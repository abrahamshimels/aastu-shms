...
export const LOGIN_LABTECH_SUCCESS = "LOGIN_LABTECH_SUCCESS";
export const LOGIN_LABTECH_ERROR = "LOGIN_LABTECH_ERROR";
export const LOGIN_LABTECH_REQUEST = "LOGIN_LABTECH_REQUEST";
